...
export default function ServicesPage() {
    return (
        <div className="py-20 px-4 max-w-5xl mx-auto">
            <h1 className="text-4xl md:text-5xl font-extrabold text-primary dark:text-accent mb-8 text-center">Our Services</h1>
            ...
            <div className="space-y-16">
                ...
                <section id="excavation" className="bg-secondary text-white rounded-2xl p-8 md:p-12 shadow-lg hover:shadow-xl transition-shadow relative overflow-hidden border-l-8 border-primary">
                    <h2 className="text-3xl font-bold text-accent mb-6 relative z-10">Commercial Excavation</h2>
                ...
                {/* Service 4 */}
                <section id="specialized" className="bg-secondary text-white rounded-2xl p-8 md:p-12 shadow-lg hover:shadow-xl transition-shadow relative overflow-hidden border-l-8 border-primary">
                    <h2 className="text-3xl font-bold text-accent mb-6 relative z-10">Hydro Excavating</h2>
                    <div className="text-gray-200 text-lg leading-relaxed flex items-start relative z-10">
                        <CheckCircle2 className="text-white mr-3 shrink-0 mt-1" size={24} />
