    ...
    return (
        <footer className="bg-secondary text-white pt-12 pb-8 border-t-4 border-primary">
            <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
                <div>
                    <h3 className="text-xl font-bold mb-4 text-accent">Cottle Construction</h3>
                ...
                <div>
                    ...
                    <ul className="space-y-2">
                        ...
                        <li><Link href="/employment" className="hover:text-accent transition-colors">Employment</Link></li>
                ...
                <div>
                    ...
                    <ul className="space-y-3">
                        <li className="flex items-start">
                            <Mail className="mr-2 text-accent shrink-0" size={20} />
                            <a href="mailto:info@cottleconstruction.com" className="hover:text-accent transition-colors">info@cottleconstruction.com</a>
                        </li>
                        <li className="flex items-start">
                            <MapPin className="mr-2 text-accent shrink-0" size={20} />
                            <span>P. O. Box 774<br />Bountiful, UT 84010</span>
                        </li>
                        <li className="flex items-start">
                            <Phone className="mr-2 text-accent shrink-0" size={20} />
                            <a href="tel:801-821-7713" className="hover:text-accent transition-colors">801-821-7713</a>
                        </li>
                    </ul>
                </div>
            </div>
